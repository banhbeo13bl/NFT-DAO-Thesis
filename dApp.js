...
const Web3Alc = createAlchemyWeb3("https://polygon-mumbai.g.alchemy.com/v2/gFDkEZNGETjKWDTxRzJQcJa-usEJzZJl");

const moralisapikey = "RCdjwMgW6QSkdILVIqcfEvqK0gK35CGmKQd0Mz4w1aI0X1rOHucXUbq6B6kzZRqG";
const polygonscanapikey = "N8ZEJN2XSB36JA45XG1FU6KYNBYH2TUJHW";
                  ...
                  <div class="header">
                    ...
                    <div class="header">
                      ...
                      <table className='table table-bordered table-dark' style={{ borderRadius: '14px' }} >
                        ...
                        <tbody>
                          <tr>
                            <td>Stake NFTD to Earn NFTD</td>
                            <td class="amount" data-test-id="rewards-summary-ads">
                              <span class="amount">0.01</span>&nbsp;<span class="currency">Per NFTD</span>
                            </td>
                          </tr>
                          <tr>
                            <td>Stake NFTD to Earn NFTD+</td>
                            <td class="amount" data-test-id="rewards-summary-ac">
                              <span class="amount">0.005</span>&nbsp;<span class="currency">Per NFTD</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
